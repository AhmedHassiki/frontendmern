...
export const getProducts = () => async(dispatch)=>{
    ...
    try {
        let result = await axios.get('https://mernbackend-p7f6.onrender.com/api/product')
...
export const deleteProduct = (id) => async(dispatch)=>{
    try {
        // console.log("id:" , id)
        await axios.delete(`https://mernbackend-p7f6.onrender.com/api/product/${id}`);
...
export const getOneProduct = (id) => (dispatch) =>{
    axios
    .get(`https://mernbackend-p7f6.onrender.com/api/product/${id}`)
...
export const postProduct = (product) => async(dispatch) => {
    try {
        await axios.post("https://mernbackend-p7f6.onrender.com/api/product", product)
        dispatch(getProducts())
    } catch (error) {
        console.log(error)
    }
...
export const editProduct = (id, product) => async(dispatch) => {
    try {
        const result = axios.patch(`https://mernbackend-p7f6.onrender.com/api/product/${id}`, product)
